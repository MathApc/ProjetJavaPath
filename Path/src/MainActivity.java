...
public class MainActivity extends Application{
	...
	public void start(Stage primaryStage) throws Exception {
		...
		// grid for playground
		GridPane grid = createGridPane(pl,vertical_borders,horizontal_borders);
	...
	private VBox createContainer() {
		...
		player_turn_label.setText("Player " + String.valueOf(turn));
	...
	private void set_background(Button btn, String image, Boolean selected) {
